...
const requiredFiles = [
  ...
  "public/images/products/card-venus-probiotics.jpg",
  "public/images/products/card-venus-stick-probiotics.jpg",
  "public/images/products/card-venus-stick-box.png",
  "public/images/products/card-kids-lac-probiotics.jpg",
  "public/images/products/card-line-n-probiotics.jpg",
  "public/images/products/card-inner-clean-v.jpg",
  "public/images/products/card-venus-inner-perfume.jpg",
...
const requiredContent = [
  ...
  ["home opens with full-screen forest vision hero", heroComponent.includes("data-vision-hero") && heroComponent.includes("/images/home-hero-forest.png") && heroComponent.includes("We Are Real Partner") && heroComponent.includes("min-h-[100svh]") && !heroComponent.includes("/images/studio/studio-iheal-lineup-hero.jpg")],
  ...
  ["home uses diagonal partner banner", homePage.includes("Global Health Partner") && homePage.includes("BIOLAB STANDARD") && homePage.includes("clip-path:polygon")],
  ...
  ["product cards normalize image frames", sourceFiles.some((file) => file.includes("cardImage") && file.includes("/images/products/card-venus-probiotics.jpg") && file.includes("/images/products/card-venus-stick-box.png")) && sourceFiles.some((file) => file.includes("displayImage") && file.includes("object-contain") && file.includes("bg-[#f7faf9]"))],
