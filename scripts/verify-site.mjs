...
const requiredContent = [
  ...
  ["strength cards use generated images", siteData.includes("science/petri-pipette-lab.jpg") && siteData.includes("competence-global.jpg") && siteData.includes("science/pharma-blister-packs.jpg") && siteData.includes("competence-family.jpg") && homePage.includes("<img") && homePage.includes("item.imageAlt")],
