...
const requiredFiles = [
  ...
  "public/images/products/card-venus-stick-cutout.png",
...
const requiredContent = [
  ...
  ["product cards normalize image frames", sourceFiles.some((file) => file.includes("cardImage") && file.includes("/images/products/card-venus-probiotics.jpg") && file.includes("/images/products/card-venus-stick-cutout.png")) && sourceFiles.some((file) => file.includes("displayImage") && file.includes("object-contain") && file.includes("bg-[#f7faf9]"))],
