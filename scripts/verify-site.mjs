...
const requiredContent = [
  ...
  ["product cards normalize image frames", sourceFiles.some((file) => file.includes("cardImage") && file.includes("/images/products/card-venus-probiotics.jpg")) && sourceFiles.some((file) => file.includes("--pv-from") && file.includes("mix-blend-multiply") && file.includes("visual.word"))],
