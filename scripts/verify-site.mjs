...
const requiredContent = [
  ...
  ["product cards normalize image frames", sourceFiles.some((file) => file.includes("cardImage") && file.includes("/images/products/card-venus-probiotics.jpg")) && sourceFiles.some((file) => file.includes('aspect-[4/3]') && file.includes("object-cover") && file.includes("product.cardImage"))],
