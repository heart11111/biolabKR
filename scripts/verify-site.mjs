...
const requiredContent = [
  ...
  ["product cards normalize image frames", sourceFiles.some((file) => file.includes("cardImage") && file.includes("/images/products/card-venus-probiotics.jpg")) && sourceFiles.some((file) => file.includes("displayImage") && file.includes("object-contain") && file.includes("bg-[#f7faf9]"))],
