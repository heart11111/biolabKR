...
export const news: NewsItem[] = [
  ...
  },
  {
    ...
    category: "수상/입점",
    date: "2025.01",
    summary: "2025년 1월 올리브영 채널 입점 이후 iHEAL 비너스 유산균 제품 정보와 판매 채널을 확인할 수 있습니다.",
    href: "/support/news/oliveyoung-venus-probiotics/",
    author: "영업본부",
    views: 326,
    body: [
      "iHEAL 비너스 유산균은 2025년 1월 올리브영 온라인 및 오프라인 채널 입점 이후 공식 판매 채널을 확대하고 있습니다.",
    ...
    image: "/images/partners/oliveyoung-logo.png",
    imageAlt: "올리브영 브랜드 로고",
  ...
  },
  {
    ...
    category: "제품/브랜드",
    date: "2024.08.01",
    summary: "키즈락 유산균의 성분, 섭취 안내, 제품 소개 자료를 최신 기준에 맞춰 정리했습니다.",
    href: "/support/news/kids-lac-product-update/",
    author: "제품기획팀",
    views: 187,
    body: [
      "키즈락 유산균 제품 정보가 최신 제품 소개 기준에 맞춰 정리되었습니다.",
      "제품 소개에는 키즈 유산균 성분, 섭취 편의성, 성장기 아이를 고려한 제품 특징을 중심으로 반영했습니다.",
