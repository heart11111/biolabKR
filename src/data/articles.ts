...
export const articles: Article[] = [
  {
    ...
    category: "여성 건강",
    date: "2026.02.10",
    excerpt: "균주의 출처, 보장균수, 구성 성분, 섭취 편의성을 함께 살펴보는 것이 좋습니다.",
    image: "/images/studio/studio-venus-probiotics.jpg",
    content: [
      "여성 유산균은 균주의 특성과 제품 설계 방향을 함께 보는 것이 중요합니다.",
      "비오랩은 특허 균주, 구성 성분, 섭취 편의성을 기준으로 iHEAL 제품 정보를 정리합니다.",
  ...
  },
  {
    ...
    category: "키즈 건강",
    date: "2026.01.26",
    excerpt: "아이 제품은 연령, 구성 성분, 섭취량, 보호자 지도 여부를 꼼꼼히 확인해야 합니다.",
    ...
    content: [
      ...
      "특정 성분에 민감한 아이는 섭취 전 전문가 상담을 권장합니다."
    ]
  }
];
